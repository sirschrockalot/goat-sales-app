 ...
 */
export function calculateVapiCost(durationMinutes) {
    return durationMinutes * COST_RATES.vapi.perMinute;
}
/**
 * Calculate ElevenLabs cost from duration
 */
export function calculateElevenLabsCost(durationMinutes) {
 ...
 */
export async function logCost(costBreakdown, metadata) {
    if (!supabaseAdmin) {
