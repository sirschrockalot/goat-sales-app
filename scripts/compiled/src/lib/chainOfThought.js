 ...
 */
import { getRandomTextureForContext } from './acousticTextures';
/**
 * Analyze seller's emotional state from transcript
 */
export function analyzeEmotionalState(transcript) {
    ...
    // Curious indicators
    if (lower.includes('tell me more') ||
 ...
 */
export function selectTacticalChoice(emotionalState, context) {
 ...
 */
export function selectAcousticTexture(tacticalChoice, emotionalState) {
    const contextMap = {
 ...
 */
export function generateCoTReasoning(transcript, context) {
 ...
 * Generate reasoning explanation
 */
function generateReasoningExplanation(emotionalState, tacticalChoice, context) {
    const explanations = {
 ...
 */
function calculateConfidence(emotionalState, tacticalChoice, context) {
 ...
 */
export function formatCoTAsThinking(cot) {
    return `<thinking>
